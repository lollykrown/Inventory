...
public class EditorActivity extends AppCompatActivity implements
    ...
    // EditText field for other fields
    ...
    private void saveProduct() {
        ...
        values.put(InventoryEntry.COLUMN_PRODUCT_DESCR, descString);
        values.put(InventoryEntry.COLUMN_PRODUCT_SUPPLIER, supplierString);

        int qua = 0;
        if (!TextUtils.isEmpty(quantityString)) {
            qua = Integer.parseInt(quantityString);
        }
        values.put(InventoryEntry.COLUMN_PRODUCT_QUANTITY, qua);

        int pri = 0;
        if (!TextUtils.isEmpty(priceString)) {
            pri = Integer.parseInt(priceString);
        }
        values.put(InventoryEntry.COLUMN_PRODUCT_PRICE, pri);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   // Parent activity context
                ...
                InventoryEntry.COLUMN_PRODUCT_NAME + " ASC");    // Default sort order
    }
